    ...
    QWidget(parent)
{
    ...
    if(_server){
        ...
        change_server_pass->setText("Змінити пароль");
        change_server_ip = new QPushButton(this);
        change_server_ip->setText("Змінити адресу");
        change_server_port = new QPushButton(this);
        change_server_port->setText("Змінити порт");
        change_server_crypt = new QPushButton(this);
        change_server_crypt->setText("Оновити ключ");
